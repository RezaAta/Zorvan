...
mlpGraph = MLPGraph(numInputs=2, numOutputs=1, numHiddenLayers=1, hiddenLayerSizes=[4], activationFunction = SigmoidNode, outputLayerType= SigmoidNode)
mlpGraph.BuildMLP()

backprop_graph = BackpropGraph(mlpGraph, learningRate = 0.2)
