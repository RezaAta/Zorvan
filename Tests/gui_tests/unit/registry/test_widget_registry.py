...
class TestWidgetRegistry:
    ...
    def test_register_widget(self):
        ...
        registry.register_widget(
            name="test_widget", viewmodel_cls=MockViewModel, view_cls=MockView
        )
    ...
    def test_register_with_metadata(self):
        ...
        registry.register_widget("test", MockViewModel, MockView, metadata=metadata)
    ...
    def test_get_widgets_by_category(self):
        ...
        registry.register_widget(
            "widget1", MockViewModel, MockView, metadata={"category": "cat1"}
        )
        registry.register_widget(
            "widget2", MockViewModel, MockView, metadata={"category": "cat1"}
        )
        registry.register_widget(
            "widget3", MockViewModel, MockView, metadata={"category": "cat2"}
        )
    ...
    def test_custom_factory(self):
        ...
        registry.register_widget(
            "test", MockViewModel, MockView, factory=custom_factory
        )
