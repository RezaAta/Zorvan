...
from gui_framework.viewmodels.palette_viewmodel import NodeInfo, PaletteViewModel
...
class TestPaletteViewModelSearch:
    ...
    def test_search_filters_nodes(self):
        ...
        for node in filtered:
            ...
            assert (
                search_text in node.display_name.lower()
                or search_text in node.node_type.lower()
                or search_text in node.description.lower()
                or search_text in node.category.lower()
            )
