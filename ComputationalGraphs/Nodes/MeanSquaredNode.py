...
class MeanSquaredNode(MovingAverageNode):
    """
    MeanSquaredNode behaves exactly like MovingAverageNode but computes
    ...
    def __repr__(self):
        ...
        return f"MeanSquaredNode('{self.name}', size={self.bufferSize}, mode='{self.mode}', ms={self.value:.6f}, buffer_fill={valid_count}/{self.bufferSize})"
