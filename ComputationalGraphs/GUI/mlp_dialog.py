...
from PyQt6.QtWidgets import (
    ...
    QLabel, QGroupBox, QMessageBox, QWidget
)
...
class MLPGeneratorDialog(QDialog):
    ...
    def _generate_mlp(self):
        ...
        try:
            ...
            hidden_act = self._get_activation_class(self.hidden_activation.currentText())
            output_act = self._get_activation_class(self.output_activation.currentText())
            ...
            QMessageBox.critical(
                self,
                "Error Generating MLP",
                f"Failed to generate MLP:\n{str(e)}"
            )
