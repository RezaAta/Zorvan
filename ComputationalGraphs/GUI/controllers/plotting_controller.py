...
class PlottingController:
    ...
    def _get_selected_backend(self):
        ...
        if hasattr(self.main_window, 'plot_backend_combo'):
            return 'pyqtgraph' if self.main_window.plot_backend_combo.currentText() == 'PyQtGraph' else 'matplotlib'
        return 'matplotlib'
    ...
    def open_plot_window(self):
        ...
        from ComputationalGraphs.GUI.plot_window import PlotConfigDialog, create_plot_window
        
        if not self.graph or len(self.graph.nodes) == 0:
            QMessageBox.warning(self.main_window, "No Graph", 
        ...
        if config_dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            if not selected_nodes:
                QMessageBox.warning(self.main_window, "No Nodes Selected", 
            ...
            if hasattr(self.main_window.graph_runner, '_iteration_counter'):
                self.plot_window.update_plot(self.main_window.graph_runner._iteration_counter)
    ...
    def add_selected_to_plot(self):
        ...
        if not node_items:
            QMessageBox.information(self.main_window, "No Nodes Selected", 
    ...
    def ensure_backend_consistency(self):
        ...
        try:
            ...
            max_iterations = getattr(self.plot_window, 'max_iterations', 
        ...
        self.plot_window = create_plot_window(current_nodes, max_iterations, None, backend=selected_backend)
