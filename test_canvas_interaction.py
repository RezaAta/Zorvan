...
from gui_framework.viewmodels.canvas_viewmodel import CanvasViewModel, NodeRenderState, EdgeRenderState
...
def test_commands():
    ...
    assert command.positions["A"] == (0, 0, 100, 100), "Merged command should have original start and final end"
