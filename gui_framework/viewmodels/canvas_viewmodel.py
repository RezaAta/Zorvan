...
class CanvasViewModel(BaseViewModel):
    ...
    viewport_changed = ObservableProperty("viewport_changed", default=0)  # Counter to trigger updates
    ...
    def load_graph(self, graph):
        ...
        print(f"[CanvasViewModel] Loaded graph with {len(self._nodes)} nodes and {len(self._edges)} edges")
