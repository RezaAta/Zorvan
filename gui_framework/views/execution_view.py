...
if PYQT_AVAILABLE:
    ...
    class ExecutionView(BaseView):
        ...
        def _bind_viewmodel(self):
            ...
            self._viewmodel.observe_property("current_step", self._on_current_step_changed)
            ...
            self._viewmodel.observe_property("is_max_speed", self._on_is_max_speed_changed)
        ...
        def _update_button_states(self):
            ...
            self.stop_button.setEnabled(self._viewmodel.is_running or self._viewmodel.is_paused)
