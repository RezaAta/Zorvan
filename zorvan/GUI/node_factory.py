...
_NODE_REGISTRY: Dict[str, tuple] = {
    # Data nodes
    "DataStreamNode": (
        "zorvan.Nodes.DataStreamNode",
        "DataStreamNode",
        {"data": [1, 2, 3, 4, 5]},
        "Data",
    ),
    "DynamicDataStreamNode": (
        "zorvan.Nodes.DynamicDataStreamNode",
        "DynamicDataStreamNode",
        {},
        "DynData",
    ),
    "BufferNode": (
        "zorvan.Nodes.BufferNode",
        "BufferNode",
        {"size": 3},
        "Buffer",
    ),
    "MovingAverageNode": (
        "zorvan.Nodes.MovingAverageNode",
        "MovingAverageNode",
        {"size": 10, "mode": "continuous"},
        "MovAvg",
    ),
    "SequencerNode": (
        "zorvan.Nodes.SequencerNode",
        "SequencerNode",
        {},
        "Seq",
    ),
    "ListNode": ("zorvan.Nodes.ListNode", "ListNode", {}, "List"),
    "ExtractListElement": (
        "zorvan.Nodes.ExtractListElement",
        "ExtractListElement",
        {"index": 0},
        "ExtractList",
    ),
    "ContainerNode": (
        "zorvan.Nodes.ContainerNode",
        "ContainerNode",
        {},
        "Container",
    ),
    "InitializableContainerNode": (
        "zorvan.Nodes.InitializableContainerNode",
        "InitializableContainerNode",
        {
            "init_low": -1.0,
            "init_high": 1.0,
    ...
    # Arithmetic nodes
    "AdditionNode": (
        "zorvan.Nodes.AdditionNode",
        "AdditionNode",
        {},
        "Add",
    ),
    "SubtractionNode": (
        "zorvan.Nodes.SubtractionNode",
        "SubtractionNode",
        {},
        "Sub",
    ),
    "MultiplicationNode": (
        "zorvan.Nodes.MultiplicationNode",
        "MultiplicationNode",
        {},
        "Mul",
    ),
    "DivisionNode": (
        "zorvan.Nodes.DivisionNode",
        "DivisionNode",
        {},
        "Div",
    ),
    "MaxNode": ("zorvan.Nodes.MaxNode", "MaxNode", {}, "Max"),
    "MinNode": ("zorvan.Nodes.MinNode", "MinNode", {}, "Min"),
    "MeanSquaredNode": (
        "zorvan.Nodes.MeanSquaredNode",
        "MeanSquaredNode",
        {},
        "MS",
    ),
    ...
    "SigmoidNode": (
        "zorvan.Nodes.SigmoidNode",
        "SigmoidNode",
        {},
        "Sigmoid",
    ),
    "SigmoidDerivativeNode": (
        "zorvan.Nodes.SigmoidDerivativeNode",
        "SigmoidDerivativeNode",
        {},
        "Sigmoid'",
    ),
    "ReLUNode": ("zorvan.Nodes.ReLUNode", "ReLUNode", {}, "ReLU"),
    "ReLUDerivativeNode": (
        "zorvan.Nodes.ReLUDerivativeNode",
        "ReLUDerivativeNode",
        {},
        "ReLU'",
    ),
    "LinearNode": ("zorvan.Nodes.LinearNode", "LinearNode", {}, "Linear"),
    "TanhNode": ("zorvan.Nodes.TanhNode", "TanhNode", {}, "Tanh"),
    "TanhDerivativeNode": (
        "zorvan.Nodes.TanhDerivativeNode",
        "TanhDerivativeNode",
        {},
        "Tanh'",
    ),
    "GaussianNode": (
        "zorvan.Nodes.GaussianNode",
        "GaussianNode",
        {},
        "Gauss",
    ),
    "PiecewiseLinearNode": (
        "zorvan.Nodes.PiecewiseLinearNode",
        "PiecewiseLinearNode",
        {},
        "Piecewise",
    ),
    ...
    "TournamentSelectionNode": (
        "zorvan.Nodes.TournamentSelectionNode",
        "TournamentSelectionNode",
        {},
        "Tournament",
    ),
    "BulkTournamentNode": (
        "zorvan.Nodes.BulkTournamentNode",
        "BulkTournamentNode",
        {},
        "BulkTour",
    ),
    "CrossoverNode": (
        "zorvan.Nodes.CrossoverNode",
        "CrossoverNode",
        {},
        "Crossover",
    ),
    "SingleCrossoverNode": (
        "zorvan.Nodes.SingleCrossoverNode",
        "SingleCrossoverNode",
        {},
        "SingleXO",
    ),
    "SingleInputCrossover": (
        "zorvan.Nodes.SingleInputCrossover",
        "SingleInputCrossover",
        {},
        "SInXO",
    ),
    "MutationNode": (
        "zorvan.Nodes.MutationNode",
        "MutaionNode",
        {},
        "Mutation",
    ),  # Note: typo preserved from original class
    "DeJongSphereNode": (
        "zorvan.Nodes.DeJongSphereNode",
        "DeJongSphereNode",
        {},
        "DeJong",
    ),
    "PopulationNode": (
        "zorvan.Nodes.PopulationNode",
        "PopulationNode",
        {},
        "Population",
    ),
    "LinearNodeDerivative": (
        "zorvan.Nodes.LinearNodeDerivative",
        "LinearNodeDerivative",
        {},
        "Linear'",
    ),
    "ElitismNode": (
        "zorvan.Nodes.ElitismNode",
        "ElitismNode",
