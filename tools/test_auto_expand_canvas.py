...
print('Scene rect left,right,top,bottom:', rect.left(), rect.right(), rect.top(), rect.bottom())
...
print('Scene rect after direct add:', rect2.left(), rect2.right(), rect2.top(), rect2.bottom())
