...
from ComputationalGraphs.GUI.layouts import MLPLayoutEngine
...
print(f'Different positions? {engine.get_grid_coords(w0) != engine.get_grid_coords(w1)}')
...
print(f'Different positions? {engine2.get_grid_coords(w_h0n0_y0) != engine2.get_grid_coords(w_h0n1_y0)}')
