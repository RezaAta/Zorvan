...
- **Naming**: Prefer prefixing filenames with `exp_` (e.g., `exp_my_experiment.py`) and avoid names that start with `test_` or match pytest collection patterns to prevent accidental test discovery.
