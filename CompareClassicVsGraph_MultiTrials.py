...
def run_comparison_trials(num_trials=10, pop_size=50, generations=100, num_elites=1):
    ...
    print(f"Configuration: {num_trials} trials, {pop_size} pop, {generations} gen, {num_elites} elite(s)")
    print("=" * 80)
...
def generate_comparison_plots(classic_results, graph_results, num_trials, pop_size, generations, num_elites):
    ...
    plt.title(f'Fitness Comparison: Classic vs Graph EA\n{num_trials} Trials, {num_elites} Elite, {generations} Gen, {pop_size} Pop', fontsize=12)
    ...
    # Plot Classic EA
    plt.plot(generations_range, classic_mean, 'b-', linewidth=2, label='Classic EA (mean)')
    plt.fill_between(generations_range, 
    ...
    plt.title(f'Convergence Comparison: Classic vs Graph EA (Mean ± Std)\n{num_trials} Trials, {num_elites} Elite, {generations} Gen, {pop_size} Pop', fontsize=12)
    ...
    ax1.plot(range(1, len(classic_mean) + 1), classic_mean, 'k-', linewidth=3, label='Mean')
    ...
    plt.title(f'Statistics Comparison: Classic vs Graph EA\n{num_trials} Trials, {num_elites} Elite, {generations} Gen, {pop_size} Pop', fontsize=12)
